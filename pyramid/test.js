...
test("exception for n = 0", () => {
  expect(() => { pyramid(0).toThrow("n is either not a number or less equal than 0");})
});

test("exception for n is negative number", () => {
  expect(() => { pyramid(-10).toThrow("n is either not a number or less equal than 0");})
});